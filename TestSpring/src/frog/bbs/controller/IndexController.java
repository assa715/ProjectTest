...
public class IndexController extends MultiActionController{
	...
	public ModelAndView login(HttpServletRequest request, HttpServletResponse response){
		...
		if(request.getParameter("userId")!=null){
			...
			if(bbs != null){
				...
				//return new ModelAndView(new RedirectView("/test/bbsList.do"),"user",bbs);
				return new ModelAndView(new RedirectView("/TestSpring/bbsList.do"));
	...
	public ModelAndView bbsList(HttpServletRequest request, HttpServletResponse response){
		...
		/*if(WebUtils.getSessionAttribute(request, "user")!= null){
			...
			return new ModelAndView(new RedirectView("/TestSpring/login.do"));
		}*/
	...
	public ModelAndView bbsModify(HttpServletRequest request, HttpServletResponse response){
		...
		if(passCon == 0){
			...
			return new ModelAndView(new RedirectView("/test/bbsView.do?seq="+bbs.getSeq()));
		}
		*/
		bbs.setSeq(new Integer(request.getParameter("seq")));
		bbs.setTitle(request.getParameter("title"));
		...
		return new ModelAndView(new RedirectView("/TestSpring/bbsView.do?seq="+bbs.getSeq()));
	}
