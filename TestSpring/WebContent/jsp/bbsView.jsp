...
<script lanaguage="javascript">
	function mod(type,value){
		if(type == 'modify'){
			location.href="bbsModifyForm.do?seq="+value+"&condition="+type;
		}
		else if(type =='delete'){
			if(confirm('삭제하시겠습니까?') == true){
				//location.href="bbsDeleteForm.do?seq="+value;
				location.href="bbsDelete.do?seq="+value;
			}
		}
		else if(type =='reply'){
			location.href="bbsReplyForm.do?seq="+value;
		}
	}
</script>
		...
		<table width="620" border="0" cellpadding="0" cellspacing="0">
			<tr>
				...
				<c:if test="${user.userId == bbsView.userId}">
					...
					<input type="button" value="목록" onClick="javascript:location.href='bbsList.do'"; />
				</td>
			</tr>
		</table>
	</div>
