...
<script type="text/javascript">
	...
	function submitType(param){
		...
		if(param == 'modify'){
			document.bbsWrite.action = "bbsModify.do";
		}else if(param == 'reply'){
			document.bbsWrite.action = "bbsReply.do";
		}
          ...
          <tr>
			...
			<table width="620" border="0" cellpadding="0" cellspacing="0">
				...
				<c:if test="${empty bbsModifyForm.seq}">
					...
					<td   width="70" align="right" valign="bottom" scope="col"><input type="button" value="목록" onClick="javascript:location.href='bbsList.do';" /></td>
				</tr>
			</table>
			</td>		
		</tr>
